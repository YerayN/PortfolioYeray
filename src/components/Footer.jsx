// ============================================================
// components/Footer.jsx — Pie de página oscuro.
// Nombre, enlaces sociales (LinkedIn, GitHub, Email) y copyright.
// ============================================================
...
export default function Footer() {
  ...
  const socialLinks = [
    {
      label: 'LinkedIn',
      href: 'https://linkedin.com/in/yeray-navarro',
      icon: (
    ...
    {
      label: 'GitHub',
      href: 'https://github.com/yeray-navarro',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="bg-dark-footer text-gray-400 py-12">
      <div className="max-w-6xl mx-auto px-6 flex flex-col items-center gap-6">
        ...
        <p className="font-body text-sm text-gray-500 text-center max-w-sm">
          Desarrollador Full Stack · Apasionado por resolver problemas reales
          con código limpio.
        </p>
          ...
          {socialLinks.map((link) => (
            <a
              ...
              className="text-gray-400 hover:text-accent transition-colors
                duration-300 ease-in-out p-2 rounded-md
                hover:bg-white/5"
            >
              {link.icon}
            </a>
        ...
        <p className="font-body text-xs text-gray-600">
          © {year} Yeray Navarro. Diseñado y desarrollado con React + Tailwind CSS.
        </p>
